...
export class CommonParametersRepository {
    ...
    public async getCommonParametersBySite(site_id: number): Promise<any> {
        ...
        [CommonParameters].[ui_timezone],[CommonParameters].[default_target_percent_of_ideal],[CommonParameters].[default_setup_minutes],[CommonParameters].[default_routed_cycle_time],
        [CommonParameters].[language],[CommonParameters].[status],[CommonParameters].[entered_by],[CommonParameters].[entered_on],[CommonParameters].[last_modified_by],[CommonParameters].[last_modified_on],
