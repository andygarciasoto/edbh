...
export class CommonParametersRepository {
    ...
    public async getCommonParametersBySite(site_id: number): Promise<any> {
		...
		CP.entered_on, CP.last_modified_by, CP.last_modified_on, CP.summary_timeout, CP.break_minutes, CP.lunch_minutes, CP.site_prefix, CP.assembly_url, CP.escalation_group
