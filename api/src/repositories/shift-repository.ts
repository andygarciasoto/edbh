...
export class ShiftRepository {
    ...
    public async findShiftByFilter(parameters: any[]): Promise<any> {
        const query = `SELECT [S].[shift_id], [S].[shift_code],[S].[shift_name],[S].[shift_description],
        [S].[shift_sequence],[S].[start_time],[S].[start_time_offset_days],[S].[end_time],[S].[end_time_offset_days],
