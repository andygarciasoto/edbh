...
export class AssetRepository {
    ...
    public async putAsset(asset_id: number, asset_code: string, asset_name: string, asset_description: string, asset_level: string, site_code: string, parent_asset_code: string, automation_level: string, include_in_escalation: boolean, grouping1: string, grouping2: string, grouping3: string, grouping4: string, grouping5: string, status: string, target_percent_of_ideal: number, is_multiple: boolean, is_dynamic: boolean, badge: string, value_stream: string): Promise<any> {
