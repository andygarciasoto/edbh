CREATE VIEW dbo.InterShiftData_vw
AS
...
FROM            dbo.InterShiftData INNER JOIN
                         dbo.Asset ON dbo.InterShiftData.asset_id = dbo.Asset.asset_id AND dbo.InterShiftData.asset_id = dbo.Asset.asset_id INNER JOIN
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'InterShiftData_vw';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'InterShiftData_vw';
