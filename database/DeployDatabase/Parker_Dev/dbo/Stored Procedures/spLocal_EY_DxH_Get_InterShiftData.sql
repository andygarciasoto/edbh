...
--		
-- Example Call:
-- exec spLocal_EY_DxH_Get_InterShiftData 67,'2019-10-01', 1
...
If Exists (Select intershift_id From [dbo].[InterShiftData] 
Where production_day = @Production_Day or production_day = @Previous_Day and asset_id = @Asset_Id)
BEGIN
