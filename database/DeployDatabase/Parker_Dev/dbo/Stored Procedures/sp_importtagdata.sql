...
--exec sp_importtagdata 'Extruder_8.PLC.FootageCount', '301.785156', 'SQL manual entry', '2020-03-25 10:50:59.813'
CREATE       PROCEDURE [dbo].[sp_importtagdata] (@tag_name AS VARCHAR(200),
