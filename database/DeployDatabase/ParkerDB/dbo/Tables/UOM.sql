CREATE TABLE [dbo].[UOM] (
    ...
    [entered_by]       NVARCHAR (100) CONSTRAINT [DF_UOM_entered_by] DEFAULT (N'SQL Manual Entry') NOT NULL,
    [entered_on]       DATETIME       CONSTRAINT [DF_UOM_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by] NVARCHAR (100) CONSTRAINT [DF_UOM_last_modified_by] DEFAULT (N'SQL Manual Entry') NOT NULL,
