...
GO
PRINT N'Creating [dbo].[DxHData].[UIX_DxHData_Asset_Id_Prod_Day_Hour_Shift]...';
...
GO
PRINT N'Altering [dbo].[spLocal_EY_DxH_Get_Shift_Data]...';
...
AS
    ...
    END;
GO
PRINT N'Altering [dbo].[spLocal_EY_DxH_Get_User_By_Clocknumber_Machine]...';
...
ALTER   PROCEDURE [dbo].[spLocal_EY_DxH_Get_User_By_Clocknumber_Machine] (@badge as VARCHAR(100), @machine as VARCHAR(100))
  AS  BEGIN 
DECLARE
	@site				INT,
	@name				VARCHAR(100),
