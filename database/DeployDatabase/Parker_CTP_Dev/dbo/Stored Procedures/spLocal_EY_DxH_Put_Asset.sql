...
CREATE    PROCEDURE [dbo].[spLocal_EY_DxH_Put_Asset] (@asset_code as NVARCHAR(100),			
	...
	@value_stream			as NVARCHAR(100),
	@automation_level		as NVARCHAR(100),
	@include				as NVARCHAR(100),
	...
	@last_modified_by		as NVARCHAR(100),
