...
--exec [dbo].[spLocal_EY_DxH_Get_User_By_Clocknumber] '2291', '0'

 CREATE   PROCEDURE [dbo].[spLocal_EY_DxH_Get_User_By_Clocknumber] (@badge as VARCHAR(100), @machine as VARCHAR(100))
