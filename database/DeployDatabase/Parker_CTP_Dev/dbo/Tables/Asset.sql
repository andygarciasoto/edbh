...
GO
CREATE UNIQUE NONCLUSTERED INDEX [UIX_Asset_Asset_Code]
    ON [dbo].[Asset]([asset_code] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [UIX_Asset_Asset_Name]
    ON [dbo].[Asset]([asset_name] ASC);
