CREATE TABLE [dbo].[DxHData] (
    ...
    [entered_by]                   NVARCHAR (100) CONSTRAINT [DF_DxHData_entered_by] DEFAULT (N'SQL Manual Entry') NULL,
    [entered_on]                   DATETIME       CONSTRAINT [DF_DxHData_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by]             NVARCHAR (100) CONSTRAINT [DF_DxHData_last_modified_by] DEFAULT (N'SQL Manual Entry') NULL,
