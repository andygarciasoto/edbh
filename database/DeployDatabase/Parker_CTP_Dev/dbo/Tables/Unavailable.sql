CREATE TABLE [dbo].[Unavailable] (
    ...
    [unavailable_code]        NVARCHAR (100) NOT NULL,
    [unavailable_name]        NVARCHAR (200) NOT NULL,
    ...
    [entered_by]              NVARCHAR (100) CONSTRAINT [DF_Unavailable_entered_by] DEFAULT (N'SQL Manual Entry') NOT NULL,
    [entered_on]              DATETIME       CONSTRAINT [DF_Unavailable_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by]        NVARCHAR (100) CONSTRAINT [DF_Unavailable_last_modified_by] DEFAULT (N'SQL Manual Entry') NOT NULL,
