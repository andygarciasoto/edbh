CREATE TABLE [dbo].[Tag] (
    ...
    [entered_by]       NVARCHAR (100) CONSTRAINT [DF_Tag_entered_by] DEFAULT (N'SQL Manual Entry') NULL,
    [entered_on]       DATETIME       CONSTRAINT [DF_Tag_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by] NVARCHAR (100) CONSTRAINT [DF_Tag_last_modified_by] DEFAULT (N'SQL Manual Entry') NULL,
