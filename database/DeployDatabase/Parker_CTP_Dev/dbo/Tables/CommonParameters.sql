CREATE TABLE [dbo].[CommonParameters] (
    ...
    [entered_by]                      NVARCHAR (100) CONSTRAINT [DF_CommonParameters_entered_by] DEFAULT (N'SQL Manual Entry') NULL,
    [entered_on]                      DATETIME       CONSTRAINT [DF_CommonParameters_entered_on] DEFAULT (getdate()) NULL,
    [last_modified_by]                NVARCHAR (100) CONSTRAINT [DF_CommonParameters_last_modified_by] DEFAULT (N'SQL Manual Entry') NULL,
    [last_modified_on]                DATETIME       CONSTRAINT [DF_CommonParameters_last_modified_on] DEFAULT (getdate()) NULL,
