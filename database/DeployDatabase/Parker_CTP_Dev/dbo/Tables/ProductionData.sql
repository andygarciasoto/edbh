CREATE TABLE [dbo].[ProductionData] (
    ...
    [entered_by]        NVARCHAR (100) CONSTRAINT [DF_ProductionData_entered_by] DEFAULT (N'SQL Manual Entry') NULL,
    [entered_on]        DATETIME       CONSTRAINT [DF_ProductionData_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by]  NVARCHAR (100) CONSTRAINT [DF_ProductionData_last_modified_by] DEFAULT (N'SQL Manual Entry') NULL,
