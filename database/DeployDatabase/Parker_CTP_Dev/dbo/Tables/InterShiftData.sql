CREATE TABLE [dbo].[InterShiftData] (
    ...
    [entered_by]       NVARCHAR (100) CONSTRAINT [DF_InterShiftData_entered_by] DEFAULT (N'SQL Manual Entry') NULL,
    [entered_on]       DATETIME       CONSTRAINT [DF_InterShiftData_entered_on] DEFAULT (getdate()) NOT NULL,
    [last_modified_by] NVARCHAR (100) CONSTRAINT [DF_InterShiftData_last_modified_by] DEFAULT (N'SQL Manual Entry') NULL,
