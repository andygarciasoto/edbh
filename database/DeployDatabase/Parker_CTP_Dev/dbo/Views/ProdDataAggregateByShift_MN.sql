CREATE VIEW dbo.ProdDataAggregateByShift_MN
AS
...
GROUP BY dbo.DxHData.asset_id, dbo.DxHData.production_day, dbo.DxHData.shift_code, dbo.DxHData.asset_id, dbo.Asset.asset_code, dbo.Asset.site_code
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ProdDataAggregateByShift_MN';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ProdDataAggregateByShift_MN';
