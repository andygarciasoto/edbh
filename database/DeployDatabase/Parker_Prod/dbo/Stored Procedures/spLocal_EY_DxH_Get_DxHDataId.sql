...
Select @Asset_Id AS asset_id, @Timestamp AS timestamp, @DxHData_Id AS dxhdata_id, @Production_Day AS production_day, @Shift_Code AS shift_code,@Hour_Interval AS hour_interval
